...
lattices = [
  ...
  Lattice(name='hd',  sim_dir='02_crystals/', T_m=273,  low_temp=20,  high_temp=340,  step_temp=20,  dflt_temp=220,  y_label=4, n_neigh=4,  pt_fmt='mo', ps_pt_fmt='#ffb6c1'),#int(CNAModifier.Type.HCP)),
  Lattice(name='cd',  sim_dir='02_crystals/', T_m=1687, low_temp=100, high_temp=2000, step_temp=100, dflt_temp=1500, y_label=5, n_neigh=4,  pt_fmt='yo', ps_pt_fmt='#008080'),#int(CNAModifier.Type.HCP)),
